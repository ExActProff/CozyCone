    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-orange accent-dark">
      <div class="container">
        <a href="#" class="navbar-brand">
          <img src="assets/dist/img/logomotel.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                      <img class="d-block w-100" src="assets/gambar/cozycone2.jpeg" alt="Second slide" height="450">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="assets/gambar/cozycone1.jpeg" alt="Third slide" height="450">
                    </div>
                  </div>
